...
<div class="right">
	<div class="right_box">
        <ul class="tk_tit">
            <li><a href="<?php echo $this->url('index',array('name'=>'company_nature'),'basicdata'); ?>" <?php if($name == 'company_nature'){?>class="on"<?php } ?>>公司性质</a></li>
	...
	<form id="info_form" action="<?php echo $this->url('doedit','','basicdata'); ?>" method="post">
            <table width="100%" class="table_form">
                ...
                <tr>
                    <td>
                        <input type="hidden" name="name" value="company_nature">
                        <input type="hidden" name="remark" value="公司性质">
