...
<div class="right">
	<div class="right_box">
        <ul class="tk_tit">
            ...
            <li><a href="<?php echo $this->url('index',array('name'=>'work_experience'),'basicdata'); ?>"  <?php if($name == 'work_experience'){?>class="on"<?php } ?>>工作经验</a></li>
	...
	<form id="info_form" action="<?php echo $this->url('doedit','','basicdata'); ?>" method="post">
            <table width="100%" class="table_form">
                        ...
                        <table width="100%" cellpadding="2" cellspacing="1" class="table_form" id="item_type">
                            <tbody class="add_item_type">
                                ...
                                <tr>
                                        ...
                                        <td><input type="text" name="setting[work_experience][]" class="-input-text" value="<?php echo $v;?>"></td>
                                    </tr>
                                <?php
                                       }
                                   }else{
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="setting[work_experience][]" class="-input-text"></td>
                                </tr>
                                   <?php } ?>
                            </tbody>
                        </table>
                ...
                <tr>
                    <td>
                        <input type="hidden" name="name" value="work_experience">
                        <input type="hidden" name="remark" value="工作经验">
...
<tr>
    ...
    <td><input type="text" name="setting[work_experience][]" class="-input-text" size="30"></td>
</tr>
</tbody>
</table>
