...
<div class="right">
	<div class="right_box">
        <ul class="tk_tit">
            ...
            <li><a href="<?php echo $this->url('index',array('name'=>'industry_classification'),'basicdata'); ?>"  <?php if($name == 'industry_classification'){?>class="on"<?php } ?>>行业领域</a></li>
            ...
            <li><a href="<?php echo $this->url('index',array('name'=>'expected_salary'),'basicdata'); ?>" >期望月薪范围</a></li>
            ...
            <li><a href="<?php echo $this->url('index',array('name'=>'jingxuanjobs'),'basicdata'); ?>" >精选职位</a></li>
	...
	<form id="info_form" action="<?php echo $this->url('doedit','','basicdata'); ?>" method="post">
            <table width="100%" class="table_form">
                        ...
                        <table width="100%" cellpadding="2" cellspacing="1" class="table_form" id="item_type">
                            <tbody class="add_item_type">
                                ...
                                <tr>
                                        ...
                                        <td>
                                            <input type="text" name="setting[industry_classification][]" class="-input-text" value="<?php echo $v;?>">
                                            <input type="text" name="setting[industry_remarks][]" class="-input-text" value="<?php echo $remarks[$k];?>">
                                        </td>
                                    </tr>
                                <?php
                                       }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="setting[industry_classification][]" class="-input-text">
                                        <input type="text" name="setting[industry_remarks][]" class="-input-text">
                                    </td>
                                </tr>
                                   <?php } ?>
                            </tbody>
                ...
                <tr>
                    <td>
                        <input type="hidden" name="name" value="industry_classification">
                        <input type="hidden" name="remark" value="industry_remarks">
...
<tr>
    ...
    <td>
        <input type="text" name="setting[industry_classification][]" class="-input-text" size="30">
        <input type="text" name="setting[industry_remarks][]" class="-input-text" size="30">
    </td>
</tr>
</tbody>
</table>
