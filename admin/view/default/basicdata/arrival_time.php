...
<div class="right">
	<div class="right_box">
        <ul class="tk_tit">
            ...
            <li><a href="<?php echo $this->url('index',array('name'=>'arrival_time'),'basicdata'); ?>" <?php if($name == 'arrival_time'){?>class="on"<?php } ?>>到岗时间</a></li>
	...
	<form id="info_form" action="<?php echo $this->url('doedit','','basicdata'); ?>" method="post">
            <table width="100%" class="table_form">
                        ...
                        <table width="100%" cellpadding="2" cellspacing="1" class="table_form" id="item_type">
                            <tbody class="add_item_type">
                                ...
                                <tr>
                                        ...
                                        <td><input type="text" name="setting[arrival_time][]" class="-input-text" value="<?php echo $v;?>"></td>
                                    </tr>
                                <?php
                                       }
                                   }else{
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="setting[arrival_time][]" class="-input-text"></td>
                                </tr>
                                   <?php } ?>
                            </tbody>
                        </table>
                ...
                <tr>
                    <td>
                        <input type="hidden" name="name" value="arrival_time">
                        <input type="hidden" name="remark" value="到岗时间">
...
<tr>
    ...
    <td><input type="text" name="setting[arrival_time][]" class="-input-text" size="30"></td>
</tr>
</tbody>
</table>
