...
<div class="-main">
	<!--right-->
        ...
        <div class="tk_main2">
            ...
            <div class="1107-add">
               <form action="<?php echo $this->url('doEdit','','role'); ?>" method="post" id="info_form" > 
            	...
            	<table border="0" cellpadding="0" cellspacing="0" class="1107-table-jbxx">
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="name" value='<?php echo $data['name']?>' class="-input-text" />
                        </td>
                    </tr> 
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text"  name="description"  value="<?php echo $data['description']?>" class="-input-text" />
                        </td>
                    </tr>                      
                   ...
                   <tr>
                        ...
                        <td>
                            <div class="-js-kc">
                                <?php if($perm){ 
                                    foreach($perm as $k=>$v){?>
                                <p class="pFl"><label><input type="checkbox" name="perm[]" <?php if($perms[$k]){ ?>checked<?php } ?> value="<?php echo $k; ?>" /><?php echo $v; ?></label></p>
                                <?php }} ?>
                            </div>
