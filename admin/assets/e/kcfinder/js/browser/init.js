    ...
    if (!this.opener.CKFinder && !this.opener.FCKEditor && !this.TinyMCE) {
        ...
        if ((
            ...
            this.opener.callBackMultiple = window.opener
                ? window.opener.KCFinder.callBackMultiple
                : window.parent.KCFinder.callBackMultiple;
                if((window.opener.KCFinder&&window.opener.KCFinder.callBackMultipleEditor)||(window.parent.KCFinder&&window.parent.KCFinder.callBackMultipleEditor))
           {  this.opener.callBackMultipleEditor = window.opener
                ? window.opener.KCFinder.callBackMultipleEditor
                : window.parent.KCFinder.callBackMultipleEditor;}
    }
};
